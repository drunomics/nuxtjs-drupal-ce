...
const storeModule = {
  ...
  mutations: {
    ...
    page (state, { statusCode, title, breadcrumbs, metatags, local_tasks, page_layout, settings }) {
      const page = {
        statusCode,
        title,
  ...
  actions: {
    ...
    async getPage ({ commit }, { path, config = {} }) {
      ...
      try {
        ...
        // Destructuring page content from the response, leaving only global data.
