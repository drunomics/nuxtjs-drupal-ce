...
// Error handling function for fetchPage and fetchMenu store actions
const handleError = (error, commit, context, options) => {
  if (error.response) {
  ...
  actions: {
    ...
    async getMenu ({ commit }, { name, config, context, options, axios }) {
      ...
      try {
        ...
        handleError(error, commit, context, options )
      }
    },
